<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConfirmRes.aspx.cs" Inherits="ZhuRui0516SkySharkWebApplication.NA.ConfirmRes" %>
         ...
         <div class="tabContents">
            <table>
                <tr>
                 ...
                 <tr>
                   <td></td>
                    <td><asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/ChangePassword.aspx" ForeColor="#CC0000">Change password</asp:HyperLink></td>
                    <td><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Logoff.aspx" ForeColor="#CC0000">Logoff</asp:HyperLink></td>
                    <td></td>
                </tr> 
                <tr>
                    <td>
