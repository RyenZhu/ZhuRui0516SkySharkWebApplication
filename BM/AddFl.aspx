<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddFl.aspx.cs" Inherits="ZhuRui0516SkySharkWebApplication.AddFl" %>
        ...
        <div class="tabContents" >
            <table>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Submit" BackColor="Silver" BorderColor="Blue" />
